...
import { Award, GraduationCap, BookOpen, FileCheck, Shield, ExternalLink } from "lucide-react";
  ...
  return (
    <section id="qualifications" className="py-24 bg-[#fafcfa]">
      <div className="max-w-6xl mx-auto px-6 lg:px-8">
        ...
        {/* A) Professional Certifications - Most Prominent */}
        <div className="mb-14">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {qualifications.education.map((edu, i) => (
              ...
              >
                ...
                <p className="text-xs text-[#a3b18a] italic">Focus: {edu.focus}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              {qualifications.courses.map((course, i) => (
                <div
                  key={i}
          ...
          <div>
            ...
            <div className="space-y-3">
              {qualifications.otherCertificates.map((cert, i) => (
                <div
                  key={i}
